 ...
 */
class GenerateRecurringDatesTest extends TestCase
{
    ...
    public function testDateBeforeYears(): void
    {
        ...
        $actual = GenerateRecurring::dateBefore($m, new \DateTime('2016-04-01'));
    ...
    {
        $m = $this->model(SalesRecurringModel::REPEAT_YEARLY, 1, '04-06');
        $actual = GenerateRecurring::dateAfter($m, new \DateTime('2016-04-01'));
    ...
    public function testDateBeforeMonths(): void
    {
        ...
        $actual = GenerateRecurring::dateBefore($m, new \DateTime('2017-09-06'));
    ...
    {
        $m = $this->model(SalesRecurringModel::REPEAT_MONTHLY, 1, '21');
        $actual = GenerateRecurring::dateAfter($m, new \DateTime('2017-09-22'));
    ...
    public function testNextDateAfter2Years(): void
    {
        ...
        $actual = GenerateRecurring::nextDateAfter($m, new \DateTime('2016-05-03'));
    ...
    {
        $m = $this->model(SalesRecurringModel::REPEAT_YEARLY, 1, '04-06');
        $actual = GenerateRecurring::nextDateAfter($m, new \DateTime('2016-04-06'));
    ...
    public function testNextDateAfter3Months(): void
    {
        ...
        $actual = GenerateRecurring::nextDateAfter($m, new \DateTime('2017-11-21'));
    ...
    public function testNextDateNoNext2Years(): void
    {
        ...
        $m = $this->model(SalesRecurringModel::REPEAT_YEARLY, 2, '04-06');
        $actual = GenerateRecurring::nextDate($m);
        $this->assertSame('2015-04-06', $actual->format('Y-m-d'));
    }
    ...
    public function testCommentWith1YearNotInStartYear(): void
    {
        ...
        $actual = GenerateRecurring::comment($m, new \DateTime('2017-04-06'));
    ...
    public function testCommentWith1MonthNotInStartYear(): void
    {
        ...
        $actual = GenerateRecurring::comment($m, new \DateTime('2017-09-21'));
